...
<div class="form-group">
  <label for="inputEmail1" class="col-lg-2 control-label">Apell. y Nomb.</label>
  <div class="col-md-8">
    <input type="text" name="rznSocialUsuario" class="form-control" id="rznSocialUsuario" placeholder="Apellidos y Nombre" value="<?php echo $dato['name'] ?>" required="">
  </div>
</div>
<div class="form-group">
