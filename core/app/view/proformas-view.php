<div class="row">
	<div class="col-md-12">
		<h1><i class='glyphicon glyphicon-shopping-cart'></i> Lista de Proformas</h1>
			...
			?>
				...
				<table class="table table-bordered table-hover	">
					...
					<tr>
						...
						<td style="width: 250px:"><?=$sell->serie."-".$sell->comprobante?></td>
						<td>
							<?php 
								$cliente = PersonData::getById($sell->person_id);
								echo $cliente->lastname." ".$cliente->name;
							?>
						</td>
						<td>
							<?php
