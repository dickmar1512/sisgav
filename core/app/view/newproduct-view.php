...
<div class="row">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio Por Mayor*</label>
    <div class="col-md-6">
      <input type="text" name="price_may" required class="form-control" id="price_may" placeholder="Precio Por Mayor">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Anaquel*</label>
    <div class="col-md-6">
      <input type="text" name="anaquel" required class="form-control" id="anaquel" placeholder="anaquel">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Con Stock:</label>
    <div class="col-md-6">
      <input type="checkbox" name="is_stock" id="is_stock" checked="">
    </div>
  </div> 
  <div class="form-group">
