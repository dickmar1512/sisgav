...
<div class="btn-group pull-right">
  <button class="hide" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
...
if($px>0):
?>
<a class="btn btn-sm btn-default" href="<?php echo "index.php?view=inventary&limit=$limit&page=".($px); ?>">
<i class="glyphicon glyphicon-chevron-left"></i> Atras </a>
<?php endif; ?>
...
<br><table class="table table-bordered table-hover">
	...
	<tr class="
	<?php 
		if($product->is_stock==0){ echo "";}
	else if($q<=$product->inventary_min/2){ echo "danger";}
	else if($product->stock<=$product->inventary_min){ echo "warning";}
	?>">
...
<!--		<a href="index.php?view=input&product_id=<?php echo $product->id; ?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-circle-arrow-up"></i> Alta</a>-->
		<a href="index.php?view=history&product_id=<?php echo $product->id; ?>" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-file"></i> GENERAR KARDEX</a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
