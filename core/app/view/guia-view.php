...
<script type="text/javascript">
	function enviarPagina(){
		var valorSeleccionado = document.querySelector('select[name="selTipoPago"]').value;
		document.getElementById('selTipoPago').value = valorSeleccionado;
	...
	<div class="col-md-10 col-md-offset-1">
		<div class="row ">
			<div class="row pull-right col-md-4">	
				<!-- <form id="pagina">	
					<input type="hidden" name="view" value="proforma">					
					<input type="hidden" name="id" value="<?=$_GET["id"]?>">
						<label for="selTipoPago" class="col-lg-2 control-label"><b>COMPROBANTE:</b></label>					
					<div class="col-md-2">
						<select id="selTipoPago" name="selTipoPago" class="form-control" onchange="enviarPagina()">
							<option value="">Elegir</option>
							<option value="addfacturap">Factura</option>
							<option value="addboletap">Boleta</option>
						</select>
					</div>
				</form>
				<?php 
					$pagina = $_GET['selTipoPago'];				 
				?> -->
				<form method="post" action="index.php?view=<?php echo $pagina?>">
					...
					<a id="editProforma" class="btn btn-success" href="index.php?view=editproforma"><i class="fa fa-edit"></i> Grabar Guia</a>
				</form>
			</div>
		</div>
		<br>
						...
						<tr style="margin-top: 0px; padding-top: 0px">
							...
							<td style="text-align: center; width: 200px; margin-top: 0px; padding-top: 0px">
								<div class="row" id="doc">
						      	...
						      	<h5 style="border-top: 1px solid #ccc; border-bottom: 1px solid #ccc; padding: 3px 0px"><b>GUIA REMITENTE</b></h5>
						      	<div><h6><?php echo "T001-".$sell->comprobante; ?></h6></div>
						      	</div>
					  		</td>
						</tr>
					</table>
