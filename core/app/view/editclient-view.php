...
<div class="row">
  ...
  <?php
      ...
      if($permiso->Pee_Valor == 1)
      {
        ?>
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" name="grado" class="form-control" id="grado" placeholder="Grado" value="<?php echo $user->company ?>">
            </div>
          </div>
        <?php
      }
      ...
      {
        ?>
          <input type="hidden" name="grado" value="" class="form-control" id="grado" value="<?php echo $user->company ?>">
        <?php
      }
    ?>
  <div class="form-group">
