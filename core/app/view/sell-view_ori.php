...
<div class="col-md-12">
			...
			<div class="row">
	        	<div class="col-md-12">
		    		...
		    		<div class="form-group">
	                    ...
	                    <div class="col-md-8">
	                      <input type="number" name="numDocUsuario" id="numDocUsuario" class="form-control" placeholder="DNI" onblur="fnBuscarDNI()" required="" value="00000000">
	                    </div>
	                </div>
	                <div id="datos3">
	                	<div class="form-group">
	...
	<div id="comprobante_guiarem" style="display:none;">
        <form action="index.php?view=addguia" class="form-horizontal" method="post" onsubmit="return enviado2()">
        	<div class="row">
	            <div class="col-md-12">
	            	<input type="hidden" name="total" 
	            	value="<?php echo number_format($total,2,'.',''); ?>">
		            ...
		            <div class="form-group">
	                	<label for="inputEmail1" class="col-lg-2 control-label">RUC:</label>
	                  	<div class="col-md-3">
	                    	<input type="number" name="numDocUsuario" class="form-control" id="ruc" placeholder="Nº de documento" onblur="validar_ruc()" required="required">
	                  	</div>
	                </div>
	                <div id="datos">
	                	<div class="form-group">
	...
	<div id="comprobante_proforma" style="display:none;">
        <form action="index.php?view=addproforma" class="form-horizontal" method="post" onsubmit="return enviado2()">
        	<div class="row">
	            <div class="col-md-12">
	            	<input type="hidden" name="total" 
	            	value="<?php echo number_format($total,2,'.',''); ?>">
    ...
    <div id="comprobante_orden" style="display: none;">
    	<form action="index.php?view=processsell" class="form-horizontal" method="post" onsubmit="return enviado2()" >
...
<script>
    ...
    function enviado2() 
	{
	    ...
	    console.log("Aqui=>",money+"-"+<?php echo $total;?>-discount);
